...
{
    public delegate void ProblemWithProduct(object sender, string problemDescription);
    ...
    partial class LogFileWriteEvent
    {
        ...
        {//If somebody wants to change the way of logging - it`s possible to choose another function
            string logFilePath = @"F:\my_study\sigma\p13\Task1\StorageUPD\StorageUPD\log.txt";
